...
XY_MD02::XY_MD02(uint8_t id, HardwareSerial *serial) : _id(id), _serial(serial) {
...
float XY_MD02::readTemperature() {
    float value = -99;
    readXY_MD02(0x01, &value);
    return value;
}

float XY_MD02::readHumidity() {
    float value = -99;
    readXY_MD02(0x02, &value);
    return value;
}
